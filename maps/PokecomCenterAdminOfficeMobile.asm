...
.MenuData:
	...
	db 3 ; items
	db "#ã€€ã¤ã†ã—ã‚“ã€€ã‚¯ãƒ©ãƒ–@" ; # Com Club
	db "ãƒ¢ãƒã‚¤ãƒ«ã‚»ãƒ³ã‚¿ãƒ¼@" ; Mobile Center
	db "ã‚„ã‚ã‚‹@" ; Quit
...
.MenuData:
	db STATICMENU_CURSOR ; flags
	db 3 ; items
	db "ã§ã‚“ã‚<WO>ã¤ã‹ã†ã¨ã@" ; Use phone
	db "ã§ã‚“ã‚<GA>ã¤ãªãŒã‚‰ãªã„ã¨ã@" ; Don't use phone
	db "ã‚„ã‚ã‚‹@" ; Quit
